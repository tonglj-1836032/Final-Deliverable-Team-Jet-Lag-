...
page_two <- tabPanel(
  ...
  sidebarLayout(
    ...
    mainPanel(
      ...
      tags$br(),
      p(
        "By looking at this chart, we would be able to examine the",
        em(
          "hospital treatment rate differences between racial and ethnicity
          groups and also within racial and ethnicity groups",
        ...
        p("For example, when comparing White and Hispanic people, we can see
        that the hospital treatment rate for white people is higher, and within
...
summary_page <- tabPanel(
  ...
  p("As for the age factors, most of COVID-19 cases are confirmed at the age
    ...
    harsh situation and do everything possible to protect ourselves from getting
